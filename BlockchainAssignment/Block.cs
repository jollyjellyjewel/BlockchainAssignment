...
namespace BlockchainAssignment
{
    class Block
    {
        ...
        public Block(Block lastBlock, List<Transaction> transactions, String minerAddress)
        {
            ...
            hash = MineParallel(); // Conduct PoW to create a hash which meets the given difficulty requirement
        }
        ...
        public override string ToString()
        {
            ...
            return "[BLOCK START]"
                ...
                + "\nBlock Time: " + blockTime + " seconds" // Include block time in the output
                + "\n-- Rewards --"
                + "\nReward: " + reward
